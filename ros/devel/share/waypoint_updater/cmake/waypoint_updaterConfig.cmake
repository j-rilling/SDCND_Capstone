...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /home/student/CarND_MIH/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /home/student/CarND_MIH/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /home/student/CarND_MIH/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/CarND_MIH/ros/src/waypoint_updater/${idir}'.  ${_report}")
    endif()
